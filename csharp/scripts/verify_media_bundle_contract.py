...
require("không có track phù hợp" in application_lower and "video vẫn hoàn tất bình thường" in application_lower, "no-subtitle path must remain non-fatal")
require("media phụ có cảnh báo" in application_lower, "thumbnail/subtitle failure must not discard a completed long video")
