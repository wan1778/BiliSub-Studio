...
Write-Host "PASS: Windows C# compile, global-log/shell contract, OCR worker contract, contract runner, short-read regression, self-contained WinUI publish, real startup smoke, worker identity, PE32+ x64 and checksum readback"
